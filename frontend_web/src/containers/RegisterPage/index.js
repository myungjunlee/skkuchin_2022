...
const RegisterPage = (props) => {
    ...
    const registerUser = (e) => {
        ...
        const user = {
            uid, username, email, password, re_password, name, major, student_id, mbti, agreement, verification
        }
                    ...
                    <div className="register_header2">
                        {
                            ...
                            pageNumber === 2
                            ?
                            <div className="upload_hleft">인증방식 선택</div>
                            :
                            pageNumber === 3
                            ?
                ...
                <form>
                    {
                        ...
                        <div>
                            ...
                            <div className="certification_image">
                                <label htmlFor="certificaion_file1">
                                    <div className="certification_image_btn">
                                        학생증 업로드하기
                                    </div>
                                </label>
                                <input
                        ...
                        <div>
                            ...
                            <div className="certification_image">
                                <label htmlFor="certificaion_file2">
                                    <div className="certification_image_btn">
                                            증명서 업로드하기
                                    </div>
                                </label>
