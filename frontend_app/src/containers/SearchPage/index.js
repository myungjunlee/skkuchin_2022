...
const SearchPage = () => {
    ...
    const handleSearchSubmit = (e) => {
        ...
        if (searchItem && searchList) {
            ...
            totalList.map((list) => {
                if (list.mbti && list.mbti.match(upperCaseMBTI))
                    searchList.push(list);
                else
                    restList.push(list);
            });
                    ...
                    <div className="search_bar">
                        <form>
                            <input
                                ...
                                ref={searchElement}
                            />
                            <button class="search_btn" type="submit" onClick={e => handleSearchSubmit(e)}><img src={icon_search} style={{verticalAlign: "middle", width: "18.96px", height: "18.97px", marginRight: "20px"}} /></button>
                        </form>
                    </div>
                </div>
            </div>
