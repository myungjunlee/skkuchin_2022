...
import { detail, update, checkAuthenticated, refreshToken, logout, logoutPost } from '../../actions';
        ...
        <div className="edit">
            ...
            <div className="edit_header">
                <div className="edit_header2">
                    ...
                    <img src={icon_close} style={{verticalAlign: "middle", width: "13px", height: "14px"}} onClick={goBack}/>
                </div>
            </div>
            {/* content 밥약신청 폼 전체 틀 */}
